...
import { createChatExpressRouter } from "./module-05-product-chatbot/api/chat.router";
import { createPostSaleExpressRouter } from "./module-04-post-sale-retention/api/post-sale.router";
...
app.use("/api/chat", createChatExpressRouter());
app.use("/api/admin/projects", createPostSaleExpressRouter());
app.use("/api/projects", createPostSaleExpressRouter());
